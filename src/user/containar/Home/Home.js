        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div className="icon-box">
              ...
              <Subtitles>Pellentesque id felis elit. Pellentesque blandit sem a nisi dictum</Subtitles>
            </div>
          </div>
          <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div className="icon-box">
              ...
              <Subtitles>Donec lacinia finibus tortor. Curabitur luctus eleifend odio.</Subtitles>
            </div>
          </div>
          <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div className="icon-box">
              ...
              <Subtitles>Aliquam auctor felis ut sem elementum, ac rutrum turpis venenatis.</Subtitles>
            </div>
          </div>
          <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div className="icon-box">
              ...
              <Subtitles>Etiam in massa eu neque euismod consectetur.</Subtitles>
            </div>
          </div>
          <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div className="icon-box">
              ...
              <Subtitles>Morbi vulputate, tortor nec pellentesque molestie</Subtitles>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="swiper-slide">
              <div className="testimonial-wrap">
                <div className="testimonial-item">
                  ...
                  <H4>Artist</H4>
                  <Subtitles>
                    <Icon className="bx bxs-quote-alt-left quote-icon-left" />
                    ...
                    <Icon className="bx bxs-quote-alt-right quote-icon-right" />
                  </Subtitles>
                </div>
              </div>
            </div>
